...
-- Equation(s):
-- \inst|decOut_n[6]~2_combout\ = (\SW[0]~input_o\ & (!\SW[3]~input_o\ & (\SW[1]~input_o\ $ (!\SW[2]~input_o\)))) # (!\SW[0]~input_o\ & (!\SW[1]~input_o\ & (\SW[3]~input_o\ $ (!\SW[2]~input_o\))))
...
-- Equation(s):
-- \inst|decOut_n~7_combout\ = ((\SW[0]~input_o\ & (\inst|decOut_n~6_combout\ $ (!\SW[3]~input_o\))) # (!\SW[0]~input_o\ & (\inst|decOut_n~6_combout\ & !\SW[3]~input_o\))) # (!\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|decOut_n~11_combout\ = ((\SW[2]~input_o\ & (!\inst|decOut_n~10_combout\ & \SW[3]~input_o\)) # (!\SW[2]~input_o\ & (\inst|decOut_n~10_combout\ & !\SW[3]~input_o\))) # (!\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|decOut_n~14_combout\ = (\SW[3]~input_o\ & (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (\SW[2]~input_o\ $ (\SW[0]~input_o\))))
