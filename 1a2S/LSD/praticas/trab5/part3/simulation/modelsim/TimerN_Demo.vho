...
SIGNAL \inst|s_count[0]~34_combout\ : std_logic;
SIGNAL \inst|s_count[0]~35_combout\ : std_logic;
SIGNAL \inst|s_count[0]~33\ : std_logic;
SIGNAL \inst|s_count[1]~36_combout\ : std_logic;
SIGNAL \inst|s_count[1]~37\ : std_logic;
...
-- Location: LCCOMB_X99_Y67_N0
\inst|Equal1~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal1~0_combout\ = (\inst|s_count\(10) & (\inst|s_count\(12) & (\inst|s_count\(7) & \inst|s_count\(9))))
...
-- Location: LCCOMB_X99_Y67_N14
\inst|Equal1~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal1~1_combout\ = (\inst|s_count\(23) & (\inst|s_count\(15) & (\inst|s_count\(20) & \inst|s_count\(19))))
...
-- Equation(s):
-- \inst|Equal0~5_combout\ = (!\inst|s_count\(24) & (!\inst|s_count\(26) & (!\inst|s_count\(27) & !\inst|s_count\(25))))
...
-- Location: LCCOMB_X99_Y67_N26
\inst|Equal0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~1_combout\ = (!\inst|s_count\(5) & (!\inst|s_count\(6) & (!\inst|s_count\(8) & !\inst|s_count\(4))))
...
-- Location: LCCOMB_X99_Y67_N16
\inst|Equal0~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~2_combout\ = (!\inst|s_count\(13) & (!\inst|s_count\(11) & (!\inst|s_count\(16) & !\inst|s_count\(14))))
...
-- Location: LCCOMB_X99_Y67_N28
\inst|Equal0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\inst|s_count\(0) & (!\inst|s_count\(3) & (!\inst|s_count\(2) & !\inst|s_count\(1))))
...
-- Location: LCCOMB_X99_Y67_N2
\inst|Equal0~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~3_combout\ = (!\inst|s_count\(17) & (!\inst|s_count\(22) & (!\inst|s_count\(18) & !\inst|s_count\(21))))
...
-- Location: LCCOMB_X99_Y67_N6
\inst|Equal0~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~7_combout\ = (\inst|Equal0~6_combout\ & (\inst|Equal0~5_combout\ & \inst|Equal0~4_combout\))
...
-- Location: LCCOMB_X99_Y67_N18
\inst|timerOut~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timerOut~0_combout\ = (!\inst|Equal0~11_combout\ & (((!\inst|Equal0~7_combout\) # (!\inst|Equal1~1_combout\)) # (!\inst|Equal1~0_combout\)))
...
-- Location: LCCOMB_X99_Y67_N24
\inst|s_count[0]~34\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|s_count[0]~34_combout\ = (\SW[0]~input_o\) # ((!\inst|timerOut~0_combout\ & ((!\SW[2]~input_o\) # (!\inst|Equal0~11_combout\))))
...
PORT MAP (
	...
	combout => \inst|s_count[0]~34_combout\);

-- Location: LCCOMB_X99_Y67_N30
\inst|s_count[0]~35\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|s_count[0]~35_combout\ = (\SW[0]~input_o\) # ((\SW[1]~input_o\ & ((\SW[2]~input_o\) # (!\inst|Equal0~11_combout\))))
...
PORT MAP (
	...
	datac => \inst|Equal0~11_combout\,
	datad => \SW[0]~input_o\,
	combout => \inst|s_count[0]~35_combout\);

-- Location: FF_X98_Y67_N1
...
PORT MAP (
	...
	sclr => \inst|s_count[0]~34_combout\,
	ena => \inst|s_count[0]~35_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst|s_count\(0));

-- Location: LCCOMB_X98_Y67_N2
\inst|s_count[1]~36\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|s_count[1]~36_combout\ = (\inst|s_count\(1) & (!\inst|s_count[0]~33\)) # (!\inst|s_count\(1) & ((\inst|s_count[0]~33\) # (GND)))
-- \inst|s_count[1]~37\ = CARRY((!\inst|s_count[0]~33\) # (!\inst|s_count\(1)))
...
PORT MAP (
	...
	combout => \inst|s_count[1]~36_combout\,
	cout => \inst|s_count[1]~37\);

-- Location: FF_X98_Y67_N3
...
-- Location: LCCOMB_X98_Y67_N4
\inst|s_count[2]~38\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|s_count[2]~38_combout\ = (\inst|s_count\(2) & (\inst|s_count[1]~37\ $ (GND))) # (!\inst|s_count\(2) & (!\inst|s_count[1]~37\ & VCC))
-- \inst|s_count[2]~39\ = CARRY((\inst|s_count\(2) & !\inst|s_count[1]~37\))
...
-- Location: LCCOMB_X99_Y67_N22
\inst|Equal0~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~6_combout\ = (!\inst|s_count\(29) & (!\inst|s_count\(31) & (!\inst|s_count\(30) & !\inst|s_count\(28))))
...
-- Location: LCCOMB_X99_Y67_N12
\inst|Equal0~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~8_combout\ = (!\inst|s_count\(10) & (!\inst|s_count\(9) & (!\inst|s_count\(7) & !\inst|s_count\(12))))
...
-- Location: LCCOMB_X99_Y67_N10
\inst|Equal0~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~9_combout\ = (!\inst|s_count\(19) & (!\inst|s_count\(20) & (!\inst|s_count\(23) & !\inst|s_count\(15))))
...
-- Location: LCCOMB_X99_Y67_N8
\inst|Equal0~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~10_combout\ = (\inst|Equal0~8_combout\ & \inst|Equal0~9_combout\)
...
-- Location: LCCOMB_X100_Y67_N8
\inst|timerOut~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timerOut~1_combout\ = (\SW[1]~input_o\ & (\inst|Equal0~11_combout\ & ((\inst|timerOut~q\) # (\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (\inst|timerOut~q\))
...
-- Location: LCCOMB_X100_Y67_N2
\inst|timerOut~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timerOut~2_combout\ = (!\SW[0]~input_o\ & ((\inst|timerOut~1_combout\) # ((\SW[1]~input_o\ & \inst|timerOut~0_combout\))))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \SW[0]~input_o\,
	datac => \inst|timerOut~1_combout\,
	datad => \inst|timerOut~0_combout\,
	combout => \inst|timerOut~2_combout\);

-- Location: FF_X100_Y67_N3
