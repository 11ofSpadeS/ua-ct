...
SIGNAL \inst|q~8_combout\ : std_logic;
...
-- Equation(s):
-- \inst|q~0_combout\ = (\SW[7]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q[7]~1_combout\ = (\SW[8]~input_o\) # (\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~2_combout\ = (\SW[6]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~3_combout\ = (\SW[5]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~4_combout\ = (\SW[4]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~5_combout\ = (\SW[3]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~6_combout\ = (\SW[2]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~7_combout\ = (\SW[1]~input_o\ & !\KEY[1]~input_o\)
...
-- Equation(s):
-- \inst|q~8_combout\ = (\SW[0]~input_o\ & !\KEY[1]~input_o\)
